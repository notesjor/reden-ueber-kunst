...
using System.Data;
using System.Linq;
using d14tive.WindowsClient.Controls.HeatMap.Model;
using Telerik.Windows.Controls;
using Telerik.Windows.Controls.TreeMap;

#endregion

namespace d14tive.WindowsClient.Controls.HeatMap
{
  /// <summary>
          ...
          switch (row.ItemArray.Length)
          {
            case 2:
              ...
              if (res.ContainsKey(key))
                ...
                res.Add(key, new HeatmapGroup(key, new[] {new HeatmapItem(string.Empty, val)}));
              break;
            case 3:
              key = row.ItemArray[0].ToString();
